...
class seekingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinnertwo = findViewById<Spinner>(R.id.tafuta)
        if (spinnertwo != null) {
        ...
        btnnexttafuta.setOnClickListener {
            val pref = this.getSharedPreferences("PREFS", Context.MODE_PRIVATE).edit()
            pref.putString("nextId",wapionetafuta.text.toString())
