...
class repairActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinnertwo = findViewById<Spinner>(R.id.tengeneza)
        if (spinnertwo != null) {
        ...
        btnnexttengeneza.setOnClickListener {
            val pref = this.getSharedPreferences("PREFS", Context.MODE_PRIVATE).edit()
            pref.putString("nextId",wapionetengeneza.text.toString())
