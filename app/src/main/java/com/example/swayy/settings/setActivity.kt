...
import com.example.swayy.MyPreferences
import com.example.swayy.R
import kotlinx.android.synthetic.main.activity_set.*
import kotlinx.android.synthetic.main.activity_set.smithrow
...
class setActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        smithrowf.setOnClickListener {
            val url = "http://www.swayy.co.ke/termsandconditions"
            val intent = Intent(Intent.ACTION_VIEW)
            intent.data = Uri.parse(url)
            startActivity(intent)
        }
        smithrowe.setOnClickListener {
            val url = "http://www.swayy.co.ke/privacypolicy"
            val intent = Intent(Intent.ACTION_VIEW)
            intent.data = Uri.parse(url)
            startActivity(intent)
        }
